RSpec.describe "Race" do
	let(:dummy_race) { CharacterSheetGenerator::Race.new("Elf", 30, "Medium", [CharacterSheetGenerator::RaceFeature::new("Dark Vision", "")], _subrace: "High Elf") }
	...
	it "has a size" do
		expect(dummy_race.size).to eq("Medium")
	end
